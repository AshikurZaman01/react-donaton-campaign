...
const DonCard = ({donation}) => {
    ...
    return (
        <div>
            <div>
            <div style={{backgroundColor : card_bg}} className="mx-auto relative flex w-full max-w-[48rem] h-[240px] flex-row rounded-xl bg-white bg-clip-border text-gray-700 shadow-md ">
     <div className='w-[200px]'>
      ...
      <div className=" px-3 py-3 h-[150px]">
       ...
       <h4  className=" block font-sans text-xl font-bold leading-snug tracking-normal text-blue-gray-900 antialiased">
         {Title}
       </h4>
